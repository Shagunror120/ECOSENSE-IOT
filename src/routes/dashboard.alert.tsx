...
import {
  AlertTriangle, Battery, Droplets, Sun, Bell, ChevronDown,
  Thermometer, Gauge, Wind, Wifi, CheckCircle2, ShieldCheck, ArrowRight, Info,
} from "lucide-react";

export const Route = createFileRoute("/dashboard/alert")({
  component: AlertsPage,
  head: () => ({ meta: [{ title: "Alerts & Device Status · EcoSense IoT" }] }),
});

const activeAlerts = [
  { Icon: AlertTriangle, color: "#dc2626", bg: "#fee2e2", title: "High Air Quality (AQI)", desc: "AQI has reached 162 which is unhealthy.", time: "10:24 AM", level: "High", lvlCls: "lvl-high" },
  { Icon: Battery,        color: "#ea580c", bg: "#ffedd5", title: "Low Battery",          desc: "Battery level is below 20%.",            time: "09:45 AM", level: "Medium", lvlCls: "lvl-med" },
  { Icon: Droplets,       color: "#ca8a04", bg: "#fef9c3", title: "Humidity Out of Range", desc: "Humidity is above normal range.",        time: "09:10 AM", level: "Low",   lvlCls: "lvl-low" },
  { Icon: Sun,            color: "#2563eb", bg: "#dbeafe", title: "Solar Input Low",       desc: "Solar input is lower than expected.",    time: "Yesterday", level: "Info", lvlCls: "lvl-info" },
];
...
const deviceInfo: { k: string; v: React.ReactNode }[] = [
  ...
  { k: "Signal Strength", v: <span className="ok-text signal-cell"><Wifi size={14} /> Excellent (92%)</span> },
];
    ...
    <div className="page">
      ...
      <div className="topbar">
        ...
        <div className="topbar-right">
          ...
          <button className="bell-btn"><Bell size={16} /><span className="bell-badge">3</span></button>
        ...
        <section className="panel">
          <div className="panel-head">
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <h2 className="panel-title" style={{ color: "#dc2626" }}>Active Alerts</h2>
            </div>
          </div>
          ...
          <div style={{ marginTop: 16 }}>
            <a href="#" className="panel-link">View All Alerts <ArrowRight size={14} /></a>
          </div>
        </section>
        ...
        <div className="stack">
          ...
          <section className="panel health-card">
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
              ...
              <h2 className="panel-title" style={{ color: "var(--blue)" }}>System Health</h2>
            </div>
  ...
  return (
    <div className="gauge">
      <svg viewBox="0 0 140 80" width="140" height="80">
        <path d="M14 70 A56 56 0 0 1 126 70" stroke="#e5e7eb" strokeWidth="12" fill="none" strokeLinecap="round" />
        <path
      ...
      <div className="gauge-val">92<span>%</span></div>
    </div>
  );
}
