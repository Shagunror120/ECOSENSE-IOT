...
import { EcoSidebar } from "@/components/ui/EcoSidebar";
import {
  Home,
  MonitorSmartphone,
  History,
...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Real-time system overview for your environmental monitoring system.",
      },
    ],
  }),
          ...
          <>
            ...
            <header className="mb-6 flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Real-time summary of your environmental monitoring system.
                </p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <Link to="/dashboard/alerts" className="relative grid h-10 w-10 place-items-center rounded-full hover:bg-muted">
                ...
                <div className="flex items-center gap-2 rounded-xl bg-card px-3 py-1.5 ring-1 ring-border">
                  <div className="grid h-8 w-8 place-items-center rounded-full bg-[var(--eco-blue)] text-xs font-bold text-white">
                    TE
                  </div>
            ...
            <section className="mb-6 grid gap-4 lg:grid-cols-2">
              <div className="rounded-2xl border bg-card p-5 shadow-[var(--shadow-card)]">
                ...
                <p className="mb-4 text-xs text-muted-foreground">
                  Energy and data flow in your system
                </p>
                <FlowDiagram />
              ...
              <div className="rounded-2xl border bg-card p-5 shadow-[var(--shadow-card)]">
                ...
                <p className="mb-4 text-xs text-muted-foreground">
                  Current status of your monitoring device
                </p>
                  ...
                  <div className="flex-1 space-y-2 text-sm">
                    {[
                      { l: "Device ID", v: "ES-2024-001" },
                      {
                        l: "Status",
                        v: (
                          <span className="rounded-full bg-[var(--eco-green-soft)] px-2 py-0.5 text-xs font-medium text-[var(--eco-green)] ring-1 ring-[var(--eco-green)]/30">
                            Online
                          </span>
                        ),
                      },
                      ...
                      { l: "Last Updated", v: "10:24:30 AM" },
                      {
                        l: "Signal Strength",
                        v: (
                          <span className="inline-flex items-center gap-1 text-[var(--eco-green)]">
                            <Wifi className="h-3.5 w-3.5" /> Excellent
                          </span>
                        ),
                      },
                    ].map((r) => (
            ...
            <section className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-2xl border bg-card p-5 shadow-[var(--shadow-card)]">
                ...
                <p className="mb-4 text-xs text-muted-foreground">
                  Latest sensor readings from the system
                </p>
                    ...
                    <tbody>
                      {recent.map((r) => (
                        <tr key={r.param} className="border-t border-border/60">
                          ...
                          <td className="py-3">
                            <span
                              className={`rounded-full px-2 py-0.5 text-xs font-medium ring-1 ${r.ok
                ...
                <a
                  href="#"
                  className="mt-3 block text-center text-sm font-medium text-[var(--eco-blue)]"
                >
                  View All Readings →
                </a>
              </div>
              ...
              <div className="rounded-2xl border bg-card p-5 shadow-[var(--shadow-card)]">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <Link to="/dashboard/alerts" className="text-xs font-medium text-[var(--eco-blue)]">
                    View All Alerts →
                  </Link>
                </div>
