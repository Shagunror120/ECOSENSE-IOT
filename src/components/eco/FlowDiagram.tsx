...
const steps = [
  ...
  { Icon: BatteryCharging,   label: "Battery",     color: "var(--eco-green)",  bg: "var(--eco-green-soft)" },
  ...
  { Icon: MonitorSmartphone, label: "Dashboard",   color: "var(--eco-purple)", bg: "var(--eco-purple-soft)" },
];
    ...
    <div>
        ...
        {steps.map((s, i) => (
          <div key={s.label} className="flex items-center gap-2">
            <div className="flex flex-col items-center gap-2">
              <div className="grid h-14 w-14 place-items-center rounded-2xl" style={{ background: s.bg }}>
      ...
      <div className="mt-3 flex items-center gap-2">
        <div className="relative h-1 flex-1 rounded-full bg-[var(--eco-green-soft)]">
          ...
          {steps.map((_, i) => (
            <div key={i} className="absolute top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-[var(--eco-green)]"
